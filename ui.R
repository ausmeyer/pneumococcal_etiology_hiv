...
#                     min = 0, max = 1, step = 0.001, value = 0.5, width = '100%')
    ...
    p("This app provides per biomarker posttest probability of S. pneumoniae infection in HIV patients with confirmed lobar pneumonia. You can input your test result to compute the posttest probability. Hover over the figure at various points to get exact values. I smooth the upper end to help with edge effects. You can also select which test you ordered and change the pretest probability. I plan to add cutoffs in the near future.")
  )
)
